...
Every failure inside microduck-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`microduck_cli.cli._output`,
...
# Exit-code policy. Documented in ``microduck-cli learn`` output.
# 0      = success
